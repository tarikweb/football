...
class Coach(models.Model):
    id_entraineur = models.ForeignKey('Entraineur', models.DO_NOTHING, db_column='Id_Entraineur', primary_key=True)  # Field name made lowercase.
    id_equipe = models.ForeignKey('Equipe', models.DO_NOTHING, db_column='Id_Equipe')  # Field name made lowercase.
    id_joueur = models.ForeignKey('Joueur', models.DO_NOTHING, db_column='Id_Joueur')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'Coach'
        unique_together = (('id_entraineur', 'id_equipe', 'id_joueur'),)
